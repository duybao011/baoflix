...
def main():
    ap = argparse.ArgumentParser(description="BảoFlix selected logic fixes V6")
    ...
    if not changed:
        print("Không có thay đổi; có thể V6 đã được áp dụng.")
        return 0
    ...
    backup_dir = root.parent / f"{root.name}_patch_backups" / f"v6_{stamp}"
